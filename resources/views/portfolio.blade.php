...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
                ...
                <div class="row">
                  <div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
                    <div class="slider-text-inner">
                      <h1 ><strong>Want to see more?</strong> <br>Check out my <a href="https://github.com/ZachAlanMueller">Github</a> to see more of what I do! </h1>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script>
    $('#selector-portfolio').addClass('fh5co-active');
  </script>
  </body>
</html>
